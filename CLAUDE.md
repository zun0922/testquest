...
- 🔲 **残タスク**：AL-TTA第3〜6章の未反映分を push で本番反映 ／ 通しプレイFB反映（確認シート回収待ち）／ B-4類似性逆引き（匠5＋澪5＋server背景も対象）／ 画像圧縮（pngquant・34MB→約1/4）／ configuration-management.skill のTestQuest適合改訂
